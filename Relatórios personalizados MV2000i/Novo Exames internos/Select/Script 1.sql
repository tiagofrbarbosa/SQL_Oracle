...
SELECT
    ...
    (SELECT Count(*)TESTE FROM dbamv.it_agenda_central WHERE cd_agenda_central = ac.cd_agenda_central AND SN_PUBLICO = 'S' AND SN_ENCAIXE = 'N' AND CD_USUARIO != 'ACESSOPEP') qt_consultas,
...
WHERE
    --To_Date(ac.dt_agenda,'DD/MM/YYYY') BETWEEN To_Date(:DT_INICIAL,'DD/MM/YYYY') AND To_Date(:DT_FINAL,'DD/MM/YYYY')
      ac.dt_agenda BETWEEN '01-09-2014' AND '04-09-2014'
