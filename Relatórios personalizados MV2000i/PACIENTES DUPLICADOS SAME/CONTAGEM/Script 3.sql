...
WHERE EXISTS (SELECT 'X'
 ...
 GROUP BY PACIENTE.DS_CHECAPAC, PACIENTE.NM_PACIENTE, PACIENTE.DT_NASCIMENTO,PACIENTE.NM_MAE, PACIENTE.NM_USUARIO,PACIENTE.CD_MULTI_EMPRESA, PACIENTE.DT_CADASTRO, SAME.CD_CAIXA, SAME.NR_MATRICULA_SAME, SAME .CD_CAD_SAME
