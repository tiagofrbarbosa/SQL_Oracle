...
--         , dbamv.glosas_sia_sus --op 22502
     ...
     WHERE eve_siasus.cd_multi_empresa = 1
      and itped_rx.cd_itped_rx = eve_siasus.cd_itped_rx
...
--       AND glosas_sia_sus.cd_apac(+) = eve_siasus.cd_apac       op 22502
       ...
       and dt_eve_siasus BETWEEN '22-08-2016' AND '23-08-2016'
       and atendime.tp_atendimento = 'E'
       and eve_siasus.cd_itped_lab is null
...
--         , dbamv.glosas_sia_sus --op 22502
         ...
         , dbamv.gru_pro gru_pro         --OP 2116
     WHERE eve_siasus.cd_multi_empresa = 1
     and itped_lab.cd_itped_lab = eve_siasus.cd_itped_lab
...
--       AND glosas_sia_sus.cd_apac(+) = eve_siasus.cd_apac       op 22502
       ...
       and dt_eve_siasus BETWEEN '22-08-2016' AND '23-08-2016'
       and atendime.tp_atendimento = 'E'
       and eve_siasus.cd_itped_rx is null
       ) 
       Group By NM_SETOR 
