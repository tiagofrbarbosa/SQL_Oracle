SELECT   eve_siasus.cd_apac
    ...
    -- ,eve_siasus.cd_ori_ate
         ...
         , DECODE ((SELECT sn_gera_atend
                     ...
                     WHERE config_ffas.cd_multi_empresa = dbamv.pkg_mv2000.le_empresa), 'N', '-', NVL (unidade_regional.tp_unidade, 'I')) tp_unidade
...
--         , dbamv.glosas_sia_sus --op 22502
     ...
     WHERE eve_siasus.cd_multi_empresa = dbamv.pkg_mv2000.le_empresa
       ...
       and fat_sia.cd_multi_empresa = dbamv.pkg_mv2000.le_empresa --OP 17753 Início/Fim.
       AND fat_sia.cd_multi_empresa = eve_siasus.cd_multi_empresa
       AND eve_siasus.cd_remessa = remessa_bpa.cd_remessa(+) --OP:1834
       --OP 22502 INICIO
       AND  (((procedimento_sus_detalhe.sn_apac_principal = 'S' or procedimento_sus_detalhe.sn_apac_secundario = 'S') AND apac.cd_multi_empresa = dbamv.pkg_mv2000.le_empresa)
       ...
       and config_ffas.cd_multi_empresa = dbamv.pkg_mv2000.le_empresa
